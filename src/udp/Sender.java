...
public class Sender implements Runnable {
    ...
    void start(int port)throws Exception{
        ...
        try
        {
            ...
            reader.close();
             protocol = lines.get(0);

             bitsOfSqeunceNo = Integer.parseInt(lines.get(1).charAt(0)+"");

             WINDOW_SIZE = Integer.parseInt(lines.get(1).trim().charAt(2)+"");

             TIMEOUT = Integer.parseInt(lines.get(2).trim().toString());

             MSS = Integer.parseInt(lines.get(3).trim().toString());
        }catch (Exception e)
        {
            e.printStackTrace();
        }
...
try {
    ...
    if (protocol.equals("GBN")) {
        ...
        System.out.println("GBN TIME: "+totalTime);
        ...
        clientSocket.close();
        long totalTime = endTime - startTime;
        System.out.println("SR TIME: "+totalTime);
        ...
        long totalTime = endTime - startTime;
        System.out.println("SW TIME: "+totalTime);
    } else {
        // close socket
        clientSocket.close();
